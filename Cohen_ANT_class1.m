...
%%% Question: What are the prominent spectral features?
%             Zoom in and count!
zoom on
...
% Note for Octave users: You will need to install the signal package (look online how to do this)
...
%%
% enough MATLAB... back to the lecture!!
%
...
for fi=1:numfrex
    ...
    % filter data
    fdat = filterFGx( signal ,fs,frex(fi),fwhm);
